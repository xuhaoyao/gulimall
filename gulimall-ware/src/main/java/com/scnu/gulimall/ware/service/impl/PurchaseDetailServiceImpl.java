...
import com.scnu.gulimall.ware.dao.PurchaseDetailDao;
...
public class PurchaseDetailServiceImpl extends ServiceImpl<PurchaseDetailDao, PurchaseDetailEntity> implements PurchaseDetailService {
    ...
    public List<PurchaseDetailEntity> selectByPurchaseId(Long id) {
        List<PurchaseDetailEntity> purchaseDetailEntities = baseMapper.selectList(new QueryWrapper<PurchaseDetailEntity>().eq("purchase_id", id));
