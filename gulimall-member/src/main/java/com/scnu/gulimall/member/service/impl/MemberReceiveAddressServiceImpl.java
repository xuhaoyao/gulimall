...
import com.scnu.gulimall.member.dao.MemberReceiveAddressDao;
...
public class MemberReceiveAddressServiceImpl extends ServiceImpl<MemberReceiveAddressDao, MemberReceiveAddressEntity> implements MemberReceiveAddressService {
    ...
    @Override
    public List<MemberReceiveAddressEntity> memberAddress(Long id) {
        return baseMapper.selectList(new QueryWrapper<MemberReceiveAddressEntity>().eq("member_id",id));
    }
